    ...
    return (
        <div className='w-full bg-gray-50 text-black  flex items-center flex-col justify-start'>
            <div className='flex items-center justify-center px-2 py-2 mb-2'>
                <h1 className='py-2 px-4 border-x-2 border-x-orange-500 font-semibold text-2xl '>Sản phẩm nổi bật</h1>
            </div>
                        ...
                        <>
                            {
                                ...
                                <h1 className='text-2xl font-semibold text-gray-500'>Không có sản phẩm</h1> 
                                :
