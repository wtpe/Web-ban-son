    ...
    return (
        <div className='w-full dark:text-black p-4 min-h-screen  bg-gray-50 flex flex-col '>
            ...
            <div className='w-full h-20 my-2 text-center'>
                <h1 className='text-2xl py-2 '>Cập nhật danh mục</h1>
            </div>
            {
                isLoading || loader ? (
                    ...
                    <div className='w-full h-full flex items-start justify-center'>
                        <form onSubmit={handleSubmit(onSubmit)} className="w-full max-w-lg  py-2 flex-col ">
                            <div className="form-control w-full mb-2">
                                ...
                                <input    {...register("name")} type="text" placeholder="" className="input input-bordered w-full" />
                            ...
                            <div className="form-control w-full mb-2">
                                ...
                                <input  {...register("slug")} type="text" placeholder="" className="input input-bordered w-full" />
                            ...
                            <div className="form-control">
                                ...
                                <textarea  {...register("description")} className="textarea textarea-bordered h-24" placeholder=""></textarea>
                            ...
                            </div>
                            {
                                catData && (
                                    ...
                                    <div className="form-control">
                                        <label className="label">
                                            <span className="label-text">Ảnh gốc</span>
                                        </label>
