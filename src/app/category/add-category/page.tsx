...
export default function AddCategory() {
    ...
    const onSubmit: SubmitHandler<Inputs> = async data => {
        ...
        if (CheckFileSize) return toast.error('Kích cỡ ảnh nhỏ hơn 1MB')
    ...
    return (
        <div className='w-full  p-4 min-h-screen  bg-gray-50 flex flex-col '>
            ...
            <div className='w-full h-20 my-2 text-center'>
                <h1 className='text-2xl py-2 dark:text-black'>Thêm danh mục</h1>
            </div>
            {
                loader ? (
                    <div className='w-full  flex-col h-96 flex items-center justify-center '>
                        <TailSpin
                            ...
                            visible={true}
                        />
                        <p className='text-sm mt-2 font-semibold text-orange-500'>Đang thêm danh mục</p>
                    </div>
                ) : (
                    ...
                    <div className='w-full h-full flex items-start justify-center'>
                        <form onSubmit={handleSubmit(onSubmit)} className="w-full max-w-lg  py-2 flex-col ">
                            ...
                            <div className="form-control w-full mb-2">
                                <label className="label">
                                    <span className="label-text">Thể loại danh mục</span>
                                </label>
                            ...
                            <div className="form-control w-full ">
                                ...
                                {errors.image && <span className='text-red-500 text-xs mt-2'>Trường nhập bắt buộc và ảnh nhỏ hơn hoặc bằng 1MB</span>}
