...
export default function AddProduct() {
    ...
    const onSubmit: SubmitHandler<Inputs> = async data => {
        ...
        const finalData = { productName: data.name, productDescription: data.description, productImage: uploadImageToFirebase, productSlug: data.slug , productFeatured  : data.feature , productPrice : data.price , productWeight : data.weight , productCategory : data.categoryID, productNorm : data.norm, productQuantity:data.quantity}
                ...
                loader ? (
                    <div className='w-full  flex-col h-96 flex items-center justify-center '>
                        <TailSpin
                            ...
                            visible={true}
                        />
                        <p className='text-sm mt-2 font-semibold text-orange-500'>Đang tải ....</p>
                    </div>
                ) : (
                        ...
                        <form onSubmit={handleSubmit(onSubmit)} className="w-full max-w-lg  py-2 flex-col ">
                            <div className="form-control w-full max-w-full">
                                ...
                                <select   {...register("categoryID", { required: true })}  className="select select-bordered">
                                    <option disabled selected>Chọn 1 danh mục</option>
                                    {
                                        category?.map((item) => {
                                            return (
                            ...
                            <div className="form-control w-full mb-2">
                                ...
                                <input {...register("name", { required: true })} type="text" placeholder="" className="input input-bordered w-full" />
                                {errors.name && <span className='text-red-500 text-xs mt-2'>Trường nhập bắt buộc</span>}
                            </div >
                            <div className="form-control w-full mb-2">
                                <label className="label">
                                    <span className="label-text">Thể loại</span>
                                </label>
                                <input  {...register("slug", { required: true })} type="text" placeholder="" className="input input-bordered w-full" />
                                {errors.slug && <span className='text-red-500 text-xs mt-2'>Trường nhập bắt buộc</span>}
                            ...
                            <div className="form-control w-full mb-2">
                                ...
                                <input  {...register("price", { required: true })} type="number" placeholder="" className="input input-bordered w-full" />
                                {errors.slug && <span className='text-red-500 text-xs mt-2'>Trường nhập bắt buộc</span>}
                            ...
                            <div className="form-control w-full mb-2">
                                ...
                                <input  {...register("quantity", { required: true })} type="number" placeholder="" className="input input-bordered w-full" />
                                {errors.slug && <span className='text-red-500 text-xs mt-2'>Trường nhập bắt buộc</span>}
                            ...
                            <div className="form-control w-full mb-2">
                                ...
                                <input  {...register("norm", { required: true })} type="text" placeholder="" className="input input-bordered w-full" />
                                {errors.slug && <span className='text-red-500 text-xs mt-2'>Trường nhập bắt buộc</span>}
                            ...
                            <div className="form-control w-full mb-2">
                                ...
                                <input  {...register("weight", { required: true })} type="number" placeholder="" className="input input-bordered w-full" />
                                {errors.slug && <span className='text-red-500 text-xs mt-2'>Trường nhập bắt buộc</span>}
                            ...
                            <div className="form-control">
                                ...
                                <textarea  {...register("description", { required: true })} className="textarea textarea-bordered h-24" placeholder=""></textarea>
                                {errors.description && <span className='text-red-500 text-xs mt-2'>Trường nhập bắt buộc</span>}
                            ...
                            <div className="form-control w-full ">
                                ...
                                {errors.image && <span className='text-red-500 text-xs mt-2'>Trường nhập bắt buộc và ảnh minh hoạ nhỏ hơn hoặc bằng 1MB.</span>}
