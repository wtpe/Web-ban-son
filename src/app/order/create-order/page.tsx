                    ...
                    <div className='w-full  h-full flex-col md:flex-row flex items-start justify-center'>
                        ...
                        <div className='md:w-2/3 w-full px-2 h-full flex-col items-end justify-end flex'>
                            <div className='w-full flex flex-col items-center py-2 overflow-auto h-96'>
                                {
                                    cartData?.length === 0 ?
                                        <div className='w-full h-full flex items-center justify-center flex-col'>
                                            <p className='my-4 mx-2 text-lg font-semibold '>Không có sản phẩm trong giỏ hàng</p>
                                            <Link href={"/"} className='btn text-white'>Trang chủ</Link>
                                        </div>
                                        :
                            ...
                            <div className='w-full  py-2 my-2 flex justify-end '>
                                <h1 className='py-2 tracking-widest mb-2  border-b px-6 border-orange-600 text-sm  flex flex-col '>  Giá gốc :  <span className='text-xl font-extrabold'>{totalPrice.toLocaleString("vi-VN", { style: "currency", currency: "VND" }) || 0} </span> </h1>
                                <h1 className='py-2 tracking-widest mb-2  border-b px-6 border-orange-600 text-sm  flex flex-col '>  Giá ship :  <span className='text-xl font-extrabold'> 10,000 </span> </h1>
                                
                            </div>
                            <div className='w-full  py-2 my-2 flex justify-end '>
                                <h1 className='py-2 tracking-widest mb-2  border-b px-6 border-orange-600 text-sm  flex flex-col '>  Thành tiền :  <span className='text-xl font-extrabold'> {(totalPrice + 600).toLocaleString("vi-VN", { style: "currency", currency: "VND" })} </span> </h1>
                            </div>
                        </div>
                        ...
                        <form onSubmit={handleSubmit(onSubmit)} className="md:w-1/3 px-2 w-full max-w-lg  py-2 flex-col ">
                            <div className="form-control w-full mb-2">
                                ...
                                {errors.fullName && <span className='text-red-500 text-xs mt-2'>Trường nhập bắt buộc</span>}
                            </div >
                            <div className="form-control w-full mb-2">
                                <label className="label">
                                ...
                                {errors.address && <span className='text-red-500 text-xs mt-2'>Trường nhập bắt buộc</span>}
                            ...
                            <div className="form-control w-full ">
                                ...
                                <input  {...register("phone", { required: true })} type="text" className="file-input file-input-bordered w-full " />
                                {errors.phone &&  <span className='text-red-500 text-xs mt-2'>Trường nhập bắt buộc</span>}
