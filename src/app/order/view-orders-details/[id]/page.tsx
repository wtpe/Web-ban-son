                    ...
                    <div className='w-full h-5/6 dark:text-black overflow-y-auto'>
                                    ...
                                    return (
                                        <div key={index} className='md:w-96 m-2 w-52 h-52 bg-gray-300  flex md:flex-row  flex-col items-center justify-start'>
                                            ...
                                            <div className='flex  px-2 py-1 flex-col items-start justify-start'>
                                                ...
                                                <p className='text-sm my-2 font-semibold'>Giá : {item?.product?.productPrice.toLocaleString("vi-VN", { style: "currency", currency: "VND" })}</p>
                                                <p className='text-sm  my-2'>Số lượng :  <span className='font-semibold'>{item?.qty}</span></p>
                        ...
                        <div className='flex flex-wrap w-full items-center justify-center'>
                            ...
                            <div className=' border m-2 w-96  flex-col flex items-start justify-start py-2 px-4'>
                                ...
                                <div className='flex py-2 w-full text-sm justify-between'>
                                    <p>Số điện thoại</p>
                                    <p className='font-semibold'>{orderData?.shippingAddress?.phone}</p>
                                </div>
                            </div>
                            <div className=' border m-2 w-96  flex-col flex items-start justify-start py-2 px-4'>
                                ...
                                <div className='flex py-2 w-full text-sm justify-between'>
                                    <p>Sản phẩm</p>
                                    <p className='font-semibold'>Giá {orderData?.itemsPrice.toLocaleString("vi-VN", { style: "currency", currency: "VND" })} </p>
                                </div>

                                <div className='flex py-2 w-full text-sm justify-between'>
                                    <p>Thành tiền</p>
                                    <p className='font-semibold'>Giá  {orderData?.totalPrice.toLocaleString("vi-VN", { style: "currency", currency: "VND" })} </p>
                                </div>
                                <div className='flex py-2 w-full text-sm justify-between'>
                                    <p>Thanh toán</p>
                                    <p className='font-semibold'>{orderData?.isPaid ? "Thanh toán" : "Pending"}</p>
                                </div>
                            </div>
